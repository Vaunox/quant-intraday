...
|---|---|---|---|---|---|
| 2026-06-17 | P0.1 | ☑ done | `feat/p0.1-repo-tooling` (committed; not pushed) | 2 passing | uv toolchain; ruff/black/mypy/pytest/pre-commit all green. Details in `docs/PROGRESS.md`. |
| | P0.2 | ☐ todo | | | next |
| | … | | | | |
